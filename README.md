...
Edit the config.php with your tokens and endpoints. If you want to use only voicetomail, then you don't need to fill the zammad parts. Make the config.php readable only by asterisk using chown & chmod 400.
